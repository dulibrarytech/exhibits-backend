...
const mockTimelinesModel = mock_model([
    'create_timeline_record',
    'get_timeline_record',
    'update_timeline_record',
    'create_timeline_item_record',
    'get_timeline_item_records',
    'get_timeline_item_record',
    'get_timeline_item_edit_record',
    'get_timeline_item_details_record',
    'update_timeline_item_record',
    'delete_timeline_item_record',
    'publish_timeline_item_record',
    'suppress_timeline_item_record',
    'unlock_timeline_item_record'
]);
