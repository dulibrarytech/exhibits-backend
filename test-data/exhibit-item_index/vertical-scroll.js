...
module.exports = [
    {
        "type": "heading", // (R)
        "is_member_of_exhibit": "1", // (R)
        "text": "Settler Colonialism and the University of Denver", // heading text (default: "")
        "subtext": "This is the Subtitle", // heading subtext, appears in smaller font under the main text (default: "")
        "order": 1, // (R)
        "is_visible": 1, // If 0, the heading is not displayed, but its link appears in the page navigation (default: 1, heading text is shown in the exhibit)
        "is_anchor": 1 // If 0, the heading link is not included in the page navigation (default: 1, heading anchor appears in navigation menu)
    },
    {
        "uuid": "f14d40a9ba5f040c5868c36b473ad7f5", // (R)
        "is_member_of_exhibit": "1", // (R)
        "title": "Settler Colonialism and the University of Denver", // (default: null, item displays no title)
        "caption": "Image from Kynewisbok, vol36, academic year 1933-1934", // (default: null, item displays no caption under media content)
        "template": "row", // {'row' | 'grid' | 'vertical-timeline'}
        "item_type": "image", // {'image', 'large_image', 'audio', 'video', 'pdf', 'external'}
        ...
        // "text": ^ (R if no "url" value)
        "type": "item", 
        "layout": "media_right", 
        "styles": { // user style settings (default: {})

            /* user styles for exhibit item (all styles available to user shown in following object) */
            "item": {
                "background": "#1a2b3c",
                "backgroundImage": "",
                "backgroundSize": "",
            ...
            /* user styles for item text section */
            "item_text": { 
                "paddingLeft": "20px",
                "paddingRight": "20px"
            },

            /* user styles for item media component */
            "item_media": {
                "width": "70%",
                "float": "right"
            },

            /* user styles for grid container (contains the grid items) */
            "item_grid": {
                "background": "white"
            }

        },
        "year_label": "", // for use in items of template 'vertical-timeline'. Inserts a year label to the timeline which precedes the item. (default: null, year label is not appended to the timeline)
        "is_published": 1, 
        "order": 2, // (R)
...

    {
        ...
        "text": "<p>The University began to reckon with its role in and responsibility farmer bill for the Sand Creek Massacre in the years leading up to the 150th anniversary of both the University and the Massacre in 2014. A committee of faculty and staff from DU and other institutions was created to inquire into the nature of John Evans’ involvement in the Sand Creek Massacre. The University of Denver \"John Evans Study Committee Report\" was produced, and the study found John Evans culpable in the Sand Creek Massacre. This report and some of the recommendations from the Native American Inclusivity Task Force (2016) helped implement some modest structural change, but these changes have proven to be inconsistent and incomplete. The Native Student Alliance (NSA) has been the primary force behind the most recent demands to remove both the “Boone” character and the “Pioneer” moniker, as both are legacies of the U.S. and DU’s history with settler colonialism. </p>"+
            "<p>As so many communities reckon with the presence and prominence of statues, memorials, flags, and other signifiers of our racist and colonial history, the University of Denver has a choice: Which side of history do we want to be on? </p>",
        "type": "item",
        "layout": "media_left",
        "styles": {
            "item": {
    ...
    {
        "uuid": "2271e313180783b0d14b453c214d6fac",
        "is_member_of_exhibit": "1",
        "title": "Settler Colonialism and the University of Denver",
        "caption": "Image from Kynewisbok, vol36, academic year 1933-1934",
        "template": "row",
        "item_type": "image",
        "media": "2271e313180783b0d14b453c214d6fac.jpeg",
    ...
    },
    {
        ...
        "caption": "Two-Page \"Homecoming\" Spread in 1976-77 Kynewisbok Yearbook",
        "template": "row",
        "item_type": "image",
        ...
        "styles": {
            "item": {
                "fontFamily": "Arial",
                "color": "white",
                "backgroundImage": "brent-learned_one-november-morning.jpeg",
    ...
    {
        "uuid": "6372d544f03300b782ab2bf39d31238a",
        "type": "heading",
        "is_member_of_exhibit": "1",
    ...
    },
    {
        ...
        "description": "\"Pioneer Pete\" character appears first as illustrations and then as a farmer bob mascot-type in the 1950s. “Pioneer Pete” was a person in costume who appeared at football games",
        "caption": "caption text",
        "template": "grid",
        "columns": "4",
        "item_type": "image",
    ...
    // large image viewer text bottom
