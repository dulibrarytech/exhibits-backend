let userModule=(()=>{let o=window.localStorage.getItem("exhibits_app_path"),c=endpointsModule.get_users_endpoints();var e={};async function r(){try{var e=helperModule.get_parameter_by_name("user_id"),a=authModule.get_user_token(),t=await httpModule.req({method:"GET",url:c.users.get_user.endpoint.replace(":user_id",e),headers:{"Content-Type":"application/json","x-access-token":a}});if(200===t.status)return t.data}catch(e){document.querySelector("#message").innerHTML=`<div class="alert alert-danger" role="alert"><i class="fa fa-exclamation"></i> ${e.message}</div>`}}function a(e,a){return 0===a.length?!(document.querySelector("#"+e+"-error").innerHTML='<span style="color: red"><i class="fa fa-exclamation-circle"></i> Please enter a value</span>'):(document.querySelector("#"+e+"-error").innerHTML="",a)}function i(){return{first_name:a("first-name-input",document.querySelector("#first-name-input").value),last_name:a("last-name-input",document.querySelector("#last-name-input").value),email:a("email-input",document.querySelector("#email-input").value),du_id:a("du-id-input",document.querySelector("#du-id-input").value)}}return e.display_user_records=async function(){try{var l=await(async()=>{try{var e=authModule.get_user_token(),a=await httpModule.req({method:"GET",url:c.users.endpoint,headers:{"Content-Type":"application/json","x-access-token":e}});if(200===a.status)return a.data}catch(e){document.querySelector("#message").innerHTML=`<div class="alert alert-danger" role="alert"><i class="fa fa-exclamation"></i> ${e.message}</div>`}})();let s="";if(!1===l)document.querySelector("#user-card").innerHTML="";else{if(0===l.length)return document.querySelector(".card").innerHTML="",!(document.querySelector("#message").innerHTML='<div class="alert alert-info" role="alert"><span id="exhibit-title"></span> No User Profiles found.</div>');for(let r=0;r<l.length;r++){var i=l[r].is_active;let e,a="",t="";var n=JSON.parse(window.sessionStorage.getItem("exhibits_user"));if(null===n)return!(document.querySelector("#message").innerHTML='<div class="alert alert-danger" role="alert"><i class="fa fa-exclamation"></i> Unable to get your user id</div>');1===i?t=(a=parseInt(n.uid)===l[r].id?(e='<span id="inactive" title="active"><i class="fa fa-user" style="color: green"></i><br>Active</span>',`<a href="${o}/users/edit?user_id=${l[r].id}" title="Edit"><i class="fa fa-edit pr-1"></i> </a>`):(e=`<a href="#" id="${l[r].id}" class="inactive-user"><span id="inactive" title="active"><i class="fa fa-user" style="color: green"></i><br>Active</span></a>`,'<i title="Can only edit if unpublished" style="color: #d3d3d3" class="fa fa-edit pr-1"></i>'),'<i title="Can only delete if unpublished" style="color: #d3d3d3" class="fa fa-trash pr-1"></i>'):0===i&&(e=`<a href="#" id="${l[r].id}" class="active-user"><span id="active" title="inactive"><i class="fa fa-user" style="color: darkred"></i><br>Inactive</span></a>`,a=`<a href="${o}/users/edit?user_id=${l[r].id}" title="Edit"><i class="fa fa-edit pr-1"></i> </a>`,t=`<a href="${o}/users/delete?user_id=${l[r].id}" title="Delete"><i class="fa fa-trash pr-1"></i></a>`),s=(s=(s=(s+="<tr>")+`<td style="width: 35%;padding-left: 7%">
                    <p><i class="fa fa-user"></i>&nbsp;&nbsp;<strong>${l[r].first_name} ${l[r].last_name}</strong></p>
                    <p><i class="fa fa-envelope"></i>&nbsp;&nbsp;${l[r].email}</p>
