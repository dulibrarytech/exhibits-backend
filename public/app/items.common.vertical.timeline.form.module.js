...
const itemsCommonVerticalTimelineItemFormModule = (function () {
    ...
    /**
     * Gets common timeline item form fields
     */
    obj.get_common_timeline_item_form_fields = function (rich_text_data) {
        ...
        try {
            ...
            // item metadata
            item.title = rich_text_data['timeline-item-title-input'].getHTMLCode();
            item.caption = rich_text_data['timeline-item-caption-input'].getHTMLCode();
            item.description = rich_text_data['timeline-item-description-input'].getHTMLCode();
            item.text = rich_text_data['timeline-item-text-input'].getHTMLCode();
