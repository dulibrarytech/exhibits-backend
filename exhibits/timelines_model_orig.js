...
const VALIDATE_CREATE_TASK = new VALIDATOR(EXHIBITS_CREATE_TIMELINE_SCHEMA);
const VALIDATE_UPDATE_TASK = new VALIDATOR(EXHIBITS_UPDATE_TIMELINE_SCHEMA);
const VALIDATE_TIMELINE_ITEM_TASK = new VALIDATOR(EXHIBITS_UPDATE_TIMELINE_ITEM_SCHEMA);
...
exports.create_timeline_record = async function (is_member_of_exhibit, data) {
    ...
    try {
        ...
        let result = await TIMELINE_RECORD_TASK.create_timeline_record(data);
...
exports.update_timeline_record = async function (is_member_of_exhibit, timeline_id, data) {
    ...
    try {
        ...
        let result = await TIMELINE_RECORD_TASK.update_timeline_record(data);
...
exports.create_timeline_item_record = async function (is_member_of_exhibit, timeline_id, data) {
    ...
    try {
        ...
        // const VALIDATE_TIMELINE_ITEM_TASK = new VALIDATOR(EXHIBITS_CREATE_TIMELINE_ITEM_SCHEMA);
        let is_valid = VALIDATE_TIMELINE_ITEM_TASK.validate(data);
        ...
        let result = await TIMELINE_RECORD_TASK.create_timeline_item_record(data);
...
exports.get_timeline_item_records = async function (is_member_of_exhibit, is_member_of_timeline) {
    ...
    try {
        ...
        const timeline_items = await TIMELINE_RECORD_TASK.get_timeline_item_records(is_member_of_exhibit, is_member_of_timeline);
...
exports.get_timeline_item_record = async function (is_member_of_exhibit, is_member_of_timeline, item_id) {
    ...
    try {
        ...
        const timeline_items = await TIMELINE_RECORD_TASK.get_timeline_item_record(is_member_of_exhibit, is_member_of_timeline, item_id);
...
exports.get_timeline_item_edit_record = async function (uid, is_member_of_exhibit, is_member_of_timeline, item_id) {
    ...
    try {
        ...
        const timeline_items = await TIMELINE_RECORD_TASK.get_timeline_item_edit_record(uid, is_member_of_exhibit, is_member_of_timeline, item_id);
...
exports.update_timeline_item_record = async function (is_member_of_exhibit, is_member_of_timeline, item_id, data) {
    ...
    try {
        ...
        let result = await TIMELINE_RECORD_TASK.update_timeline_item_record(data);
...
exports.delete_timeline_item_record = async function (is_member_of_exhibit, timeline_id, timeline_item_id) {
    ...
    try {
        ...
        return {
            ...
            data: await TIMELINE_RECORD_TASK.delete_timeline_item_record(is_member_of_exhibit, timeline_id, timeline_item_id)
        };
...
exports.publish_timeline_record = async function (exhibit_id, timeline_id) {
    ...
    try {
        ...
        const is_item_published = await TIMELINE_RECORD_TASK.set_timeline_to_publish(timeline_id);
...
exports.suppress_timeline_record = async function (exhibit_id, item_id) {
    ...
    try {
        ...
        const is_item_suppressed = await TIMELINE_RECORD_TASK.set_timeline_to_suppress(item_id);
        ...
        for (let i = 0; i < timeline_records.length; i++) {
            ...
            await TIMELINE_RECORD_TASK.set_to_suppressed_timeline_items(timeline_records[i].is_member_of_exhibit);
            ...
            for (let j = 0; j < items.length; j++) {
                await TIMELINE_RECORD_TASK.set_to_suppressed_timeline_items(items[j].is_member_of_timeline);
            }
        }
...
exports.publish_timeline_item_record = async function (exhibit_id, timeline_id, timeline_item_id) {
    ...
    try {
        ...
        let timeline_record = await TIMELINE_RECORD_TASK.get_timeline_record(exhibit_id, timeline_id);
        ...
        let timeline_item_record = await TIMELINE_RECORD_TASK.get_timeline_item_record(exhibit_id, timeline_id, timeline_item_id);
        ...
        if (is_indexed === false) {
            ...
            await TIMELINE_RECORD_TASK.update_timeline_item_record(data);
