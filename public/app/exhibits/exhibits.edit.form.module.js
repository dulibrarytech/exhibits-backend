...
const exhibitsEditFormModule = (function () {
    ...
    obj.update_exhibit_record = async function () {
        ...
        const show_message = (type, message, icon = 'fa-info') => {
            ...
            // Reset opacity for new messages
            message_el.style.opacity = '1';
            message_el.style.transition = '';
            message_el.innerHTML = '';
            message_el.appendChild(alert_div);
        };

        // Helper function to smoothly clear message
        const clear_message_smoothly = () => {
            ...
            message_el.style.transition = `opacity ${FADE_DURATION}ms ease-out`;
