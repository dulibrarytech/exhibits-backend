let exhibitsModule=(()=>{let x=window.localStorage.getItem("exhibits_app_path");var e={};let i;async function a(a){try{var e=endpointsModule.get_exhibits_endpoints(),t=authModule.get_user_token(),i=await httpModule.req({method:"POST",url:e.exhibits.exhibit_publish.post.endpoint.replace(":exhibit_id",a.replace("-status","")),headers:{"Content-Type":"application/json","x-access-token":t}});return void 0!==i&&200===i.status&&(setTimeout(()=>{let t=document.getElementById(a);document.getElementById(a).classList.remove("publish-exhibit"),document.getElementById(a).classList.add("suppress-exhibit"),document.getElementById(a).replaceWith(t.cloneNode(!0)),document.getElementById(a).innerHTML='<span id="suppress" title="published"><i class="fa fa-cloud" style="color: green"></i><br>Published</span>',document.getElementById(a).addEventListener("click",async e=>{e.preventDefault(),await s(t.getAttribute("id"))},!1)},0),setTimeout(()=>{a=a.replace("-status","");var e=`<a href="${x}/items?exhibit_id=${a}" title="View Exhibit Items"><i class="fa fa-list pr-1"></i></a>&nbsp;`,t=a+"-actions",t=document.getElementById(t),i=`<a href="${x}/exhibits/exhibit/details?exhibit_id=${a}" title="View details" aria-label="exhibit-details"><i class="fa fa-folder-open pr-1"></i> </a>`;x;t.innerHTML=`
                        ...
                        ${e}&nbsp;
                        ${i}&nbsp;
                        `+a},0)):void 0===i&&(scrollTo(0,0),document.querySelector("#message").innerHTML='<div class="alert alert-danger" role="alert"><i class="fa fa-danger"></i> You do not have permission to unplublish this record.</div>',setTimeout(()=>{document.querySelector("#message").innerHTML=""},3e3)),!1}catch(e){document.querySelector("#message").innerHTML='<div class="alert alert-danger" role="alert"><i class="fa fa-exclamation"></i> An error occurred while suppressing exhibit</div>',setTimeout(()=>{document.querySelector("#message").innerHTML=""},5e3)}}return e.display_exhibits=async function(){var n=await(async()=>{try{var e=endpointsModule.get_exhibits_endpoints(),t=authModule.get_user_token(),i=await httpModule.req({method:"GET",url:e.exhibits.exhibit_records.endpoint,headers:{"Content-Type":"application/json","x-access-token":t}});if(void 0!==i&&200===i.status)return i.data.data}catch(e){document.querySelector("#message").innerHTML=`<div class="alert alert-danger" role="alert"><i class="fa fa-exclamation"></i> ${e.message}</div>`}})();let o="";if(!1===n)return document.querySelector("#exhibit-card").innerHTML="",!1;if(void 0===n&&authModule.redirect_to_auth(),0===n.length)return document.querySelector(".card").innerHTML="",!(document.querySelector("#message").innerHTML='<div class="alert alert-info" role="alert">No Exhibits found.</div>');for(let r=0;r<n.length;r++){var d=n[r].uuid,c=n[r].is_published,u=n[r].is_featured,h=x+"/preview?uuid="+d,p=`<a href="${x}/items?exhibit_id=${d}" title="View Exhibit Items"><i class="fa fa-list pr-1"></i></a>&nbsp;`,b=new Date(n[r].created),m=new Date(n[r].updated),b=helperModule.format_date(b),m=helperModule.format_date(m),f="Exhibit created by "+n[r].created_by;let e="",t="",i,a="",s="",l="";1===c?(i=`<a href="#" id="${d}-status" class="suppress-exhibit" aria-label="exhibit-status"><span id="suppress" title="published"><i class="fa fa-cloud" style="color: green"></i><br>Published</span></a>`,s=`<a href="${x}/exhibits/exhibit/details?exhibit_id=${d}" title="View details" aria-label="exhibit-details"><i class="fa fa-folder-open pr-1"></i> </a>`,l='<i title="Can only delete if unpublished" style="color: #d3d3d3" class="fa fa-trash pr-1" aria-label="delete-exhibit"></i>'):0===c&&(i=`<a href="#" id="${d}-status" class="publish-exhibit" aria-label="exhibit-status"><span id="publish" title="suppressed"><i class="fa fa-cloud-upload" style="color: darkred"></i><br>Unpublished</span></a>`,s=`<a href="${x}/exhibits/exhibit/edit?exhibit_id=${d}" title="Edit" aria-label="edit-exhibit"><i class="fa fa-edit pr-1"></i> </a>`,l=`<a href="${x}/exhibits/exhibit/delete?exhibit_id=${d}" title="Delete exhibit" aria-label="delete-exhibit"><i class="fa fa-trash pr-1"></i></a>`),1===u&&(a='&nbsp;&nbsp;<i class="fa fa-star" title="Featured" aria-label="featured exhibit" style="color: #BA8E23"></i>'),t=`<p><img src="${e=0<n[r].thumbnail.length?x+`/api/v1/exhibits/${d}/media/`+n[r].thumbnail:x+"/static/images/image-tn.png"}" alt="${d}-thumbnail" height="100" width="100"></p>`,c=helperModule.strip_html(helperModule.unescape(n[r].title)),o=(o=(o=(o=(o+=`<tr id="${d}">`)+`<td style="width: 35%">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    ...
                                    &nbsp;&nbsp;
                                    <span id="share-link">
                                    <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target=".shared-url-modal" onclick="exhibitsModule.create_shared_preview_url('${d}');">
